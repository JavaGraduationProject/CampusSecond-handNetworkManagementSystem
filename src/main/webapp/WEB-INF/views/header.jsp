...
<div class="row">
    ...
    <div class="col-md-8">
        <ul class="nav nav-pills pull-right">
            ...
            <li><a href="${pageContext.request.contextPath}/admin/login" target="_blank">后台管理</a></li>
        </ul>
    </div>
</div>
<div id="header-nav" >
    <nav class="navbar navbar-default" id="header-nav-middle" style="background-color:#6CA6CD;">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">校园二手网</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" target="_blank" href="${pageContext.request.contextPath}/information">个人信息</a></li>
                    <li><a class="a-color" target="_blank" href="${pageContext.request.contextPath}/info/list">我的订单</a></li>
                    <li><a class="a-color" target="_blank" href="${pageContext.request.contextPath}/info/address">收货地址</a></li>
                    <li><a class="a-color" target="_blank" href="${pageContext.request.contextPath}/info/favorite">我的收藏</a></li>
                </ul>
                <form class="navbar-form navbar-left" role="search" method="get" action="">
                 <p style="color: white;">校园二手网－最安全方便的校园二手市场,是校园内的个人闲置物品交易平台</p>
                    <p style="color: white;">校园二手网 - 主要特色为方便和安全,更适合同学们在校内进行二手交易</p>
                </form>
