    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                ...
                <p>商品的一些基本信息</p>
                <form action="${pageContext.request.contextPath}/admin/goods/addGoodsSuccess" class="templatemo-login-form" method="post" enctype="multipart/form-data" onsubmit="return checkfile()">
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
                            <label class="control-label" for="inputWithSuccess">商品名称</label>
                            <input type="text" class="form-control" placeholder="请输入商品名称，最好16字以内" maxlength="16" id="inputWithSuccess" name="goodsname">
                        </div>
                    </div>
                    <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12">
                            <p style="color: red;">单图片上传,图片大小不能超过1M,最好jpg格式.</p>
                            <label class="control-label templatemo-block">图片</label>
                            <!-- <input type="file" name="fileToUpload" id="fileToUpload" class="margin-bottom-10"> -->
                            <input type="file" onchange="checkfile()" name="fileToUpload" id="fileToUpload" class="filestyle" data-buttonName="btn-primary" data-buttonBefore="true" data-icon="false" multiple="multiple">
                            <p style="color: red;">单图片上传,图片大小不能超过1M,最好jpg格式。</p>
                        </div>
                    </div>
